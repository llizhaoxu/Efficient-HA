...
python generate_response_chair_llava.py \
    ...
    --output "/projects/_ssd/ZhaoxuCode/Efficient-HA/Result1/output_dola.json" \
    --method "dola" \
    --max_tokens 512 \
...
python generate_response_chair_llava.py \
    ...
    --output "/projects/_ssd/ZhaoxuCode/Efficient-HA/Result1/InstructBlip/output_dola.json" \
    --method "dola" \
    --max_tokens 512 \
...
python generate_response_chair_llava.py \
    --device "cuda:0" \
    --model_id "Qwen/Qwen2.5-VL-7B-Instruct" \
    --output "/projects/_ssd/ZhaoxuCode/Efficient-HA/Result1/Qwen2.5-VL-7B/output_dola.json" \
    --method "dola" \
    --max_tokens 512 \
...
python generate_response_chair_llava.py \
    --device "cuda:0" \
    --model_id "OpenGVLab/InternVL3-8B" \
    --output "/projects/_ssd/ZhaoxuCode/Efficient-HA/Result1/InternVL3-8B/output_dola.json" \
    --method "dola" \
    --max_tokens 512 \
