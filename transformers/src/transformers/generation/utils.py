    ...
    def prepare_inputs_for_generation_cd(
        ...
        **kwargs,
        ...
        if past_key_values is not None:
            ...
            inputs_embeds_cd, input_ids = self._cache_dependant_input_preparation(
                input_ids, inputs_embeds_cd, cache_position
            )
        ...
        if not self.config.is_encoder_decoder:
            if inputs_embeds_cd is not None and len(cache_position) == inputs_embeds_cd.shape[1]:
